...
<body>
	<div class="container">
		...
		<div class="row">
			<p>We are happy that you are interested for football competetion</p>
			...
			<a href="{{ url('/') }}/verify_mail_football/{{$verification_string }}" class="btn btn-primary">{{ url('/') }}/verify_mail_football/{{$verification_string }} </a>
		</div>
	</div>
</body>
</html>